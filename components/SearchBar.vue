...
export default {
  ...
  methods: {
    gettitulo: function () {
      axios
        .get(
          'https://s3.us-west-2.amazonaws.com/secure.notion-static.com/f7388385-522e-4b1e-b33c-8d27b1c73ddd/movies.json?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=AKIAT73L2G45O3KS52Y5%2F20211103%2Fus-west-2%2Fs3%2Faws4_request&X-Amz-Date=20211103T010109Z&X-Amz-Expires=86400&X-Amz-Signature=7ed349182ce820299732cafa3fc8b8dae40fcaeaf9b81cee505924ea8f539263&X-Amz-SignedHeaders=host&response-content-disposition=filename%20%3D%22movies.json%22'
        )
        .then((response) => {
